export default class Header {
  ...
  initMobileMenu() {
    ...
    this.mainToggles = Array.prototype.slice.call(
  ...
  initScrollListener() {
    window.addEventListener('scroll', () => {
      const isEnable = window.pageYOffset > this.scrollDistance;
  ...
  initSubMenu() {
    Array.prototype.slice
      .call(this.container.querySelectorAll(this.schem.subitems))
      .forEach((subitem) => {
    ...
    document.addEventListener('click', (evt) => {
      ...
      if (
        !!this.state.expandedSublist
          ...
          && !this.state.expandedSublist.container.contains(evt.target)
      ) {
        this.collapseSubMenu();
      }
    });
